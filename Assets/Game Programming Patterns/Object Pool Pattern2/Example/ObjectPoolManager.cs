...
namespace ObjectPoolPatternExample2
{
    ...
    class Pool
    {
        private Stack<ObjectToPool> availableObjStack = new Stack<ObjectToPool>();
        ...
        public Pool(string poolName, GameObject ObjectToPoolPrefab, int initialCount, bool fixedSize)
        {
